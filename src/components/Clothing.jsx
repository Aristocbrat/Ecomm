...
const ClothingBs = (Bs) => {
  ...
  <div className="card-body">
    ...
    <h2 className="card-price">#{Bs.price}</h2>
    ...
    <div className="ratings flex text-[16px] justify-between">
               ...
               <button className="btn btn-success mx-auto rounded-full text-white" onClick={()=>addItem(Bs.item)} ><IoMdAddCircle /></button>
               <button className="btn bg-red-600  mx-auto rounded-full text-white" onClick={()=>removeItem(Bs.item)} ><GrSubtract /></button>
               </div>
