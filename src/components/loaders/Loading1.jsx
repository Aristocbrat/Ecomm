...
const Loading1 = () => {
  return (
    ...
    <p className='flex sm:w-[200px] xl:w-[890px] sm:pt-[10px] xl:pt-2 xl:mx-auto xl:ps-[16%] '><IoMdPricetag className='xl:text-4xl sm:text-lg'/>We make shopping </p>
    <div className="words overflow-hidden relative font-extrabold xl:mr-[250px] sm:ml-[-2%] sm:text-[19px] xl:text-4xl  xl:w-[270px]">
