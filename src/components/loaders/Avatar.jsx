...
const Avatar = () => {
  ...
  <span className='font-extrabold text-blue-950 xl:w-[470px] sm:w-[250px]  sm:text-[11px] xl:text-lg flex xl:left-10 sm:left-6  relative z-0 '>Visitors monthly , You can join Our Online community on Social-media</span>
</div>
