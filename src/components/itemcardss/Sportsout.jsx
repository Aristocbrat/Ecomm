...
<button className="xl:btn btn-success mx-auto rounded-full text-white" onClick={()=>addItem(So.item)} ><IoMdAdd className='text-xl font-extrabold' /></button>
<button className="xl:btn xl:bg-red-600  mx-auto rounded-full text-white" onClick={()=>removeItem(So.item.id)} ><GrSubtract /></button>
</div>
</div>
</div>
</section>
